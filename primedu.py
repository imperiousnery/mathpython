...
def analyze_prime_distances(n):
    ...
    # Arredondar as diferenças para o número inteiro mais próximo
    rounded_prime_diffs = np.round(prime_diffs).astype(int)
    ...
    print("Diferenças entre números primos (após o arredondamento):", rounded_prime_diffs)
