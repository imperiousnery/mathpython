...
def generate_undertale_music(duration, output_folder):
    ...
    file_name = f"{current_date}_{current_time}_undertale_music.mid"
...
generate_undertale_music(duration, output_folder)
