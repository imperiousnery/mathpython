    ...
    try:
        ...
        with ThreadPoolExecutor() as executor:
            if search_engine_choice == "google":
                ...
                future = executor.submit(search, query, tld="co.in", num=10, stop=10, pause=2, user_agent="Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/58.0.3029.110 Safari/537.3")
